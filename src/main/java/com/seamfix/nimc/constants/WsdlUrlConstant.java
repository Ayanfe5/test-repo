...
public class WsdlUrlConstant {
    ...
    public static final URL DATA_RECEPTION_WSDL_FILE_URL = WsdlUrlConstant.class.getClassLoader().getResource("soapresources/nimc/identitysearch/DataReception.wsdl");
}
